...
#import "CIImage+ATScaleExtension.h"

@implementation CIImage (ATScaleExtension)

- (UIImage *)at_createNonInterpolatedWithWidthAndHeight:(CGFloat)widthAndHeight
{
    CGRect extent = CGRectIntegral(self.extent);
    CGFloat scale = fmin(widthAndHeight/CGRectGetWidth(extent), widthAndHeight/CGRectGetHeight(extent));
